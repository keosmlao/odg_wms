...
const base = (extra = "h-4 w-4") => `${extra}`;

export function ArrowDownIcon({ className = "h-5 w-5", strokeWidth = 2 }: IconProps) {
  return (
...
export function ArrowLeftRightIcon({ className = "h-5 w-5", strokeWidth = 2 }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
      <path d="M8 3 4 7l4 4" />
      <path d="M4 7h16" />
