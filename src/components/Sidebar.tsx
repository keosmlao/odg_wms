...
import { topItems, visibleGroupsFor, type NavGroupDef } from "@/lib/nav";
import { ChevronRightIcon, ListIcon, SearchIcon } from "@/components/ui/Icons";
...
export default function Sidebar({ session }: { session: Session | null }) {
  ...
  const visibleGroups = visibleGroupsFor(session);
