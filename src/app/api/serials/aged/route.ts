 ...
 * Returns: { items:[{ sn, wh_code, item_brand, status_name, first_in, arrived_wh }] }
 */
...
export async function GET(request: Request) {
  ...
  const items = await query<{
    ...
    `WITH bal AS (
       SELECT si.sn, si.wh_code, si.isn, b.item_brand
     ...
     SELECT bal.sn, bal.wh_code, bal.item_brand, '${STATUS_INSTOCK}' AS status_name,
